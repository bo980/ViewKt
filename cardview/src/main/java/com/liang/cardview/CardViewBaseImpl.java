...
class CardViewBaseImpl implements CardViewImpl {
    ...
    public void initialize(CardViewDelegate cardView, Context context,
                           ColorStateList backgroundColor, float radius, float elevation, float maxElevation, int mShadowColor) {
        RoundRectDrawableWithShadow background = createBackground(context, backgroundColor, radius,
                elevation, maxElevation,mShadowColor);
    ...
    private RoundRectDrawableWithShadow createBackground(Context context,
                                                         ...
                                                         float maxElevation, int mShadowColor) {
